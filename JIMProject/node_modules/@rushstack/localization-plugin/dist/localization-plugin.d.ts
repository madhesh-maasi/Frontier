 ...
 * @internal
 */
export declare interface _ILocalizationFile {
 ...
 * @internal
 */
export declare interface _ILocalizedString {
    value: string;
    comment?: string;
}
 ...
 * @internal
 */
export declare interface _IParseLocFileOptions {
    terminal: ITerminal;
    filePath: string;
    content: string;
 ...
 * @internal
 */
export declare class _LocFileParser {
