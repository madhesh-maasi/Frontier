...
class SPBuildRig {
    constructor() {
        ...
        this.nodeSupportedVersionRange = '>=10.13.0 <11.0.0 || >=12.13.0 <13.0.0 || >=14.15.0 <15.0.0';
    }
    initialize(gulp) {
        ...
        try {
            ...
            const normalizedRootPath = true_case_path_1.trueCasePathSync(originalRootPath);
