...
var RequireLoader = /** @class */ (function () {
    ...
    RequireLoader.prototype.delete = function (manifest) {
        var _a;
        var name = normalize_1.normalizeComponentId(manifest.id, manifest.version);
    ...
    RequireLoader.prototype.loadEntryPoint = function (manifest, name, globalName) {
        var normalizedName = name
            ? normalize_1.normalizeName(manifest, name)
            : normalize_1.normalizeComponentId(manifest.id, manifest.version);
    ...
    RequireLoader.prototype._loadComponent = function (manifest, retryCount) {
        ...
        var requireMonitor;
        var fallbackMonitor;
        if (killSwitches_1.isSkipFirstPartyTinyLogKillswtichActivated() || !manifest.isInternal) {
        ...
        var loadAllDeps = function () {
            return Promise.all(dependencyLoading_1.loadComponentDependencies(_this, manifest, depNames));
        };
        return this._configurator
            ...
            return Promise.all(dependencyLoading_1.loadPathDependencies(_this, manifest, depNames));
        })
            .then(function () {
            ...
            if (manifest.loaderConfig.entryModuleId) {
                ...
                _this.ensure(normalize_1.normalizeComponentId(manifest.id, manifest.version), {});
            }
            return component;
        })
            .catch(function (e) {
