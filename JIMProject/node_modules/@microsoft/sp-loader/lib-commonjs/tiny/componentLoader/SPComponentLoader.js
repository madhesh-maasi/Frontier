...
var SPComponentLoader = /** @class */ (function () {
    function SPComponentLoader(loaderArgs) {
        ...
        if (!killSwitches_1.isDisable3PCodeKillswitchActivated()) {
        ...
        if (debugManifests) {
            if (!registerAsNonDebug && !killSwitches_1.isDangerouslyEnableDebugKSActivated()) {
        ...
        for (var _i = 0, assemblyComponents_1 = assemblyComponents; _i < assemblyComponents_1.length; _i++) {
            ...
            var shouldPin = !debugLoader && id !== componentConstants_1.reactComponentId && id !== componentConstants_1.reactDomComponentId;
            ...
            if (manifest) {
                var cid = normalize_1.normalizeComponentId(manifest.id, manifest.version);
                if (shouldPin) {
    ...
    SPComponentLoader.prototype.loadComponent = function (manifest) {
        ...
        if (killSwitches_1.isSkipFirstPartyLoaderLogKillswtichActivated() || !manifest.isInternal) {
    ...
    SPComponentLoader.prototype._startApplication = function (preloadedData) {
        return platformLoader_1.startApplication(preloadedData, this._serviceScope).then(function (app) {
            /*
