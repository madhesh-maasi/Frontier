...
var strings = tslib_1.__importStar(require("../../stores/Stores.resx"));
/**
...
var ComponentStore = /** @class */ (function () {
    ...
    ComponentStore.prototype.tryGetComponent = function (id, version) {
        return this._componentPromises.get(normalize_1.normalizeComponentId(id, version));
    };
    /**
    ...
    ComponentStore.prototype.tryGetComponentReference = function (id, version) {
        return this._components.get(normalize_1.normalizeComponentId(id, version));
    };
    /**
    ...
    ComponentStore.prototype.getComponentById = function (id) {
        ...
        var normalizedId = normalize_1.normalizeComponentId(id, versions[0]);
        var retVal;
