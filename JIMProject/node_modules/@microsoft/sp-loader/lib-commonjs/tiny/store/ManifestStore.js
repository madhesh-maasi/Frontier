...
var ManifestStore = /** @class */ (function () {
    ...
    ManifestStore.prototype.addManifest = function (manifest, shouldOverwrite, shouldPin, isDebug) {
        ...
        if (!killSwitches_1.isReactProfilerKSActivated()) {
            ...
            if (isReactProfilingQueryStringEnabled) {
        ...
        var normalizedId = normalize_1.normalizeComponentId(id, version);
        ...
        if (shouldPin ||
            (!sp_core_library_1._SPFlight.isDebugFlightEnabled && isInternal && id !== componentConstants_1.reactComponentId && id !== componentConstants_1.reactDomComponentId)) {
    ...
    ManifestStore.prototype.clearManifests = function () {
        ...
        this._store.forEach(function (sEntry, sKey) {
            if (!sEntry.isPinned && sKey !== componentConstants_1.reactComponentId && sKey !== componentConstants_1.reactDomComponentId) {
    ...
    ManifestStore.prototype.deleteManifest = function (id, version) {
        ...
        if (storeEntry.manifests.size === 1) {
            ...
            var cid = normalize_1.normalizeComponentId(id, version);
...
var OldManifestStoreShim = /** @class */ (function () {
    function OldManifestStoreShim(serviceScope, webAbsoluteUrl) {
        this._impl = new ManifestStore(new ManifestProvider_1.ManifestProvider(serviceScope, webAbsoluteUrl));
    }
    ...
    OldManifestStoreShim.prototype.getManifest = function (id, version) {
        ...
        if (m) {
            ...
            throw new Error("Manifest not found " + normalize_1.normalizeComponentId(id, version || ''));
        }
    };
    ...
    OldManifestStoreShim.prototype.requestManifest = function (id, version) {
        var _this = this;
        if (killSwitches_1.isRequestManifestKillSwitchActivated()) {
