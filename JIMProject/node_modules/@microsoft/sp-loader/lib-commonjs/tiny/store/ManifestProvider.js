...
var ManifestProvider = /** @class */ (function () {
    ...
    ManifestProvider.prototype.fetchManifests = function (requests) {
        var isKSNotActivated = !killSwitches_1.isRejectOnNotFoundManifestsKillSwitchActivated();
        var logSuccess = !killSwitches_1.isLogSuccessOfTryGetManifestsKillSwitchActivated();
        ...
        return this._httpClient
            .post(((this._pageContext.web && this._pageContext.web.absoluteUrl) || this._webAbsoluteUrl) + "/_api/web/GetClientSideComponents", sp_http_1.SPHttpClient.configurations.v1, {
            body: JSON.stringify(body)
        })
            .then(function (response) {
            if (!response.ok) {
                throw new Error("ManifestProvider GetClientSideComponents failed with HTTP status " + response.status + " and correlation id " + response.correlationId);
            }
