...
var strings = tslib_1.__importStar(require("./SystemsJs.resx"));
/**
 * Loader for SystemJS.
...
var SystemJsLoader = /** @class */ (function () {
    ...
    SystemJsLoader.prototype.delete = function (manifest) {
        return this._delete(normalizeName_1.default(manifest));
    };
    /**
    ...
    SystemJsLoader.prototype.load = function (manifest, name, globalName) {
        var _this = this;
        return this.systemImport(normalizeName_1.default(manifest, name)).then(function (module) {
            var retValue = module;
            ...
            if (!name && manifest.loaderConfig.exportName) {
                ...
                _this._ensure(normalizeName_1.default(manifest, manifest.loaderConfig.exportName), retValue);
            }
            return retValue;
        });
    };
    SystemJsLoader.prototype.loadFromFailoverPath = function (name) {
        return this.systemImport(normalizeName_1.normalizeFailoverPathName(name));
    };
    /**
     * Calls System.import()
    ...
    SystemJsLoader.prototype.systemImport = function (name) {
        try {
            ...
            sp_diagnostics_1._TraceLogger.logError(telemetryConstants.loadComponentLogSource, error, SystemJsLoader.systemImportEventName);
            ...
            if (resources[name_1].type === 'component') {
                ...
                if (moduleConfiguration.failoverPath) {
                    if (this._configuredFailoverPaths.indexOf(name_1) === -1) {
                        ...
                        var address = resolveAddress_1.default(manifest, name_1);
                        // Start downloading the script without evaluating it.
                        // tslint:disable-next-line: no-floating-promises
                        loadScriptWithoutEval_1.loadScriptWithoutEval(address, false /* Do not append .js to url */);
        ...
        var loader = {
            ...
            locate: function (module) {
                ...
                if (address) {
                    ...
                    sp_diagnostics_1._TraceLogger.logVerbose(telemetryConstants.loadComponentLogSource, "Address not found for module name: " + module.name + ". Using it as absolute URL.");
    ...
    SystemJsLoader.prototype._configureMetadata = function (normalizedName, address, resource) {
        ...
        if (isCorsEnabled_1.default(address)) {
