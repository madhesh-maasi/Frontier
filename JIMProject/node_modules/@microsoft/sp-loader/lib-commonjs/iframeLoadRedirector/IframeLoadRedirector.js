...
var IframeLoadRedirector = /** @class */ (function () {
    function IframeLoadRedirector() {
        ...
        this._checkApplicationStarted = function (message) {
            ...
            var timeoutId = _this._timeoutMap.get(new URL(message.origin).hostname);
            if (data.event === 'onApplicationStarted' &&
                data.identifier === 'f87d7709-c7f1-4dc4-9935-9ceee66a32fb' &&
                timeoutId !== undefined) {
    ...
    IframeLoadRedirector.prototype.confirmLoadOrRedirect = function (frameUrl) {
        ...
        if (!this._timeoutMap.has(mapKey) && !redirectMap[mapKey]) {
            ...
            var id = setTimeout(function () {
                return (window.location.href = "" + frameUrl + separator_1 + exports.REDIRECT_PARAM + "=" + encodeURIComponent(window.location.href));
            }, WAIT_PERIOD);
