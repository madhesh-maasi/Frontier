...
var strings = tslib_1.__importStar(require("./../Components/DeveloperModules/PerformanceDisplay/PerformanceDisplay.resx"));
var PerformanceDisplayStateProvider = /** @class */ (function () {
    ...
    PerformanceDisplayStateProvider.getState = function () {
        ...
        try {
            ...
            var data = sp_telemetry_1._PerformanceLogger.getPerformanceData(); // tslint:disable-line:no-any
            ...
            toReturn.errorMessage = sp_core_library_1.Text.format(strings.UnknownPerformanceDataErrorMessage, error);
            console.debug(toReturn.errorMessage); // tslint:disable-line:no-console
            return toReturn;
        }
    };
