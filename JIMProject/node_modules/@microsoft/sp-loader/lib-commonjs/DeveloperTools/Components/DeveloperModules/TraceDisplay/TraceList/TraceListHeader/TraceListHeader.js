...
var strings = tslib_1.__importStar(require("./../../TraceDisplay.resx"));
var TraceListHeader = /** @class */ (function (_super) {
    ...
    TraceListHeader.prototype.render = function () {
        ...
        return (React.createElement("ul", { className: TraceListHeader_module_scss_1.default.container },
            React.createElement("li", { className: TraceListHeader_module_scss_1.default.timestamp }, strings.TimestampHeaderLabel),
            React.createElement("li", { className: TraceListHeader_module_scss_1.default.level },
                React.createElement("p", { role: 'button', onClick: this._handleLevelClick, className: TraceListHeader_module_scss_1.default.headerText }, strings.LevelHeaderLabel),
                React.createElement("button", { onClick: this._handleLevelClick, className: [TraceListHeader_module_scss_1.default.filterButton, Styling_1.getIconClassName('Filter')].join(' ') }),
            ...
            React.createElement("li", { className: TraceListHeader_module_scss_1.default.scope },
                React.createElement("p", { role: 'button', onClick: this._handleScopeClick, className: TraceListHeader_module_scss_1.default.headerText }, strings.ScopeHeaderLabel),
                React.createElement("button", { onClick: this._handleScopeClick, className: [TraceListHeader_module_scss_1.default.filterButton, Styling_1.getIconClassName('Filter')].join(' ') }),
            ...
            React.createElement("li", { className: TraceListHeader_module_scss_1.default.source },
                React.createElement("p", { role: 'button', onClick: this._handleSourceClick, className: TraceListHeader_module_scss_1.default.headerText }, strings.SourceHeaderLabel),
                React.createElement("button", { onClick: this._handleSourceClick, className: [TraceListHeader_module_scss_1.default.filterButton, Styling_1.getIconClassName('Filter')].join(' ') }),
                React.createElement("div", { className: this._getFilterStyleForColumn('source'), id: 'sourceFilterDropdown' }, Object.keys(this.props.filters.source).map(function (id) { return (React.createElement("div", { key: id, className: TraceListHeader_module_scss_1.default.filterRow },
                    ...
                    id)); }))),
            React.createElement("li", { className: TraceListHeader_module_scss_1.default.message }, strings.MessageHeaderLabel)));
    };
    /**
