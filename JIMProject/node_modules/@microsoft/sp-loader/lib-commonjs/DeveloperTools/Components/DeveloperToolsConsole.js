...
var strings = tslib_1.__importStar(require("./../DeveloperTools.resx"));
var DeveloperToolsConsole = /** @class */ (function (_super) {
    ...
    DeveloperToolsConsole.prototype.render = function () {
        ...
        if (this.state.visible) {
            var tabs = this.state.tabs.map(function (tab, id) {
                return (React.createElement(Pivot_1.PivotItem, { linkText: tab.title, itemIcon: tab.iconName },
            ...
            return (React.createElement("div", { className: DeveloperToolsConsole_module_scss_1.default.container, style: { height: this.state.topPosition * 100 + "%" } },
                ...
                React.createElement("div", { className: DeveloperToolsConsole_module_scss_1.default.toolsArea },
                    React.createElement(Pivot_1.Pivot, { linkSize: Pivot_1.PivotLinkSize.normal, linkFormat: Pivot_1.PivotLinkFormat.links, styles: this._calculatePivotStyles(this.props.theme) }, tabs),
                    React.createElement(Button_1.IconButton, { className: DeveloperToolsConsole_module_scss_1.default.closeButton, iconProps: { iconName: 'Cancel' }, title: strings.closeDeveloperToolsAriaLabel, ariaLabel: strings.closeDeveloperToolsAriaLabel, onClick: this._handleCancelClick }))));
        }
        else {
    ...
    DeveloperToolsConsole = tslib_1.__decorate([
        Utilities_1.customizable('DeveloperToolsConsole', ['theme'])
