...
var strings = tslib_1.__importStar(require("./BrowserDeveloperToolsWarning.resx"));
...
function showBrowserDevToolsWarning() {
    ...
    var warningLine2 = sp_core_library_1.Text.format(strings.warningLine2, WARNING_URL);
