...
var strings = tslib_1.__importStar(require("./Utilities.resx"));
/**
...
function resolveAddress(manifest, resourceName, useSecondaryCdn) {
    ...
    if (!manifest.loaderConfig.scriptResources.hasOwnProperty(resourceName)) {
        var error = new Error(sp_core_library_1.Text.format(strings.resourceNotFoundError, resourceName, manifest.id, manifest.alias));
