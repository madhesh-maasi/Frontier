...
var ResourceUrlChecker = /** @class */ (function () {
    ...
    ResourceUrlChecker.checkResourceUrl = function (manifest, name) {
        ...
        var url = resolveAddress_1.default(manifest, name, ResourceUrlChecker.useSecondaryCdn);
    ...
    ResourceUrlChecker._getUrlStatus = function (url) {
        ...
        return window
            ...
            sp_diagnostics_1._TraceLogger.logError(ResourceUrlChecker._logSource, error);
            return UrlStatus.NetworkError;
        });
    };
    ResourceUrlChecker.useSecondaryCdn = false;
    ResourceUrlChecker._logSource = sp_diagnostics_1._LogSource.create('ResourceUrlChecker');
