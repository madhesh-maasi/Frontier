...
var SPLoaderError = /** @class */ (function (_super) {
    ...
    function SPLoaderError(errorCode, innerError, isExpected) {
        ...
        var _this = _super.call(this, SPLoaderErrorCode[errorCode], sp_core_library_1.Text.format.apply(sp_core_library_1.Text, tslib_1.__spreadArrays([SPLoaderError._errorCodeToMessageMap.get(errorCode)], params))) || this;
