...
var ErrorBuilder = /** @class */ (function () {
    ...
    ErrorBuilder.buildModuleHasUndeclaredDependencyError = function (manifest, dependencyName) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.moduleHasUndeclaredDependencyError, undefined, true, // This is an error when building the manifest/JS so it's an expected error
    ...
    ErrorBuilder.buildMissingPathDependencyError = function (manifest, dependencyName) {
        ...
        return this.buildErrorWithVerboseLog(SPLoaderError_1.SPLoaderErrorCode.missingPathDependencyError, undefined, true, telemetryConstants.loadComponentLogSource, undefined, dependencyName, manifest.id, manifest.alias, Object.keys(manifest.loaderConfig.scriptResources).join(strings.listSeparator));
    };
    ...
    ErrorBuilder.buildLoadScriptWithStringError = function () {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.loadScriptWithStringError, undefined, true, // Expected error, as it is caused by a wrong input from the user
    ...
    ErrorBuilder.buildUrlStatusLocalhostFileNotFoundError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusLocalhostFileNotFoundError, undefined, true, // Expected error, as it is caused by a user action (not running gulp serve)
    ...
    ErrorBuilder.buildUrlStatusFileNotFoundError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusFileNotFoundError, undefined, true, // Expected error, as it is caused by a wrong URL in the manifest
        telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusForbiddenError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusForbiddenError, undefined, true, // Expected error, as it is caused by accessing a URL/CDN without permission
        telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusClientErrorError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusClientErrorError, undefined, false, // Unexpected error
        telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusServerErrorError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusServerErrorError, undefined, false, // Unexpected error
        telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusLocalhostNetworkErrorError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusLocalhostNetworkErrorError, undefined, true, // Expected error, as it is caused by a user action (not running gulp serve)
        telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusDocLibNetworkErrorError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusDocLibNetworkErrorError, undefined, true, // Expected error, as it is caused by the tenant admin not enabling CDN
        telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusHttpsNetworkErrorError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusHttpsNetworkErrorError, undefined, true, telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusNetworkErrorError = function (manifest, resourceName, url) {
        // <value>Failed to load URL '{3}' for resource '{2}' in component '{0}' ({1}). There was a network problem.</value>
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusNetworkErrorError, undefined, true, telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildUrlStatusUndefinedError = function (manifest, resourceName, url) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.urlStatusUndefinedError, undefined, false, // Unexpected error
        telemetryConstants.loadScriptLogSource, undefined, manifest.id, manifest.alias, resourceName, url);
    };
    ErrorBuilder.buildScriptFailedToCreateGlobalError = function (globalName, scriptUrl) {
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.failedToCreateGlobalVariable, undefined, false, telemetryConstants.loadScriptLogSource, undefined, globalName, scriptUrl);
    };
    ErrorBuilder.buildModuleHasFailedDependencyError = function (resource, dependency) {
        ...
        return this.buildErrorWithErrorLog(SPLoaderError_1.SPLoaderErrorCode.dependencyLoadError, undefined, true, // Unexpected error
    ...
    ErrorBuilder.buildErrorWithVerboseLog = function (errorCode, innerError, isExpected, source, eventName) {
        ...
        var error = new (SPLoaderError_1.default.bind.apply(SPLoaderError_1.default, tslib_1.__spreadArrays([void 0, errorCode, innerError, isExpected], params)))();
