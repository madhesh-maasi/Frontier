...
var DebugStatus_1 = require("../debug/DebugStatus");
...
var DeveloperToolsProxy_1 = tslib_1.__importDefault(require("../DeveloperTools/DeveloperToolsProxy"));
...
var strings = tslib_1.__importStar(require("./Starter.resx"));
...
var SPStarter = /** @class */ (function () {
    ...
    SPStarter.start = function (preloadedData, handleFailure, debugData, isFirstFlush) {
        ...
        if (debugData && !killSwitches_1.isDangerouslyEnableDebugKSActivated()) {
            DebugStatus_1.DebugStatus.dangerouslyEnableDebug();
        }
        var serviceScope = createRootScope_1.createRootScope(spPageContextInfo);
        ManifestStore_1.default.instance = new ManifestStore_2.OldManifestStoreShim(serviceScope, spPageContextInfo.webAbsoluteUrl);
        ...
        return DebugManager_1.DebugManager.initialize(componentLoader, debugData)
            ...
            DeveloperToolsProxy_1.default.initialize(developerToolsLoader, serviceScope);
            ...
            SPStarter._logDataInRealTime();
            return _this.handleError(error, strings.loaderUserFriendlyError, sp_telemetry_1._Telemetry.isInitialized ? 'ClientError' : 'ClientErrorBeforeTelemetry', correlationId, preloadedData);
        });
    };
    ...
    SPStarter._initializeTelemetry = function (preloadedData) {
        ...
        sp_telemetry_1._Telemetry.initialize(manifests[0].alias, spPageContextInfo, buildNumber, clientSideApplicationId, SPStarter._isConsoleLogEnabled(), listItemUniqueId);
    ...
    SPStarter._initializeFlightsAndKillswitches = function (spPageContextInfo) {
        ...
        var allowDebugQueryParameter = sp_core_library_1._SPFlight.isDebugFlightEnabled || sp_core_library_1.Environment.type === sp_core_library_1.EnvironmentType.Local;
        if (allowDebugQueryParameter) {
            sp_core_library_1._SPFlight.setDebugFlights(this._getQueryParamValue(DEBUG_FLIGHTS_QUERY_PARAM));
    ...
    SPStarter._isTelemetryDisabled = function () {
        return (SPStarter._isQueryParameterTrue('disableTelemetry') ||
            sp_core_library_1._SPFlight.isEnabled(ARIA_DISABLE_TELEMETRY_LOGGING_FLIGHT_ID));
    };
