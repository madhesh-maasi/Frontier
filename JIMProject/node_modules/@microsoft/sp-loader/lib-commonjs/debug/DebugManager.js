...
var strings = tslib_1.__importStar(require("./DebugManager.resx"));
/**
...
var DebugManager = /** @class */ (function () {
    ...
    DebugManager._getDebugScripts = function (componentLoader, resolve, registerAsNonDebug) {
        ...
        Promise.all([debugLoaderPromise, debugManifestsFilePromise])
            ...
            if (error instanceof Error) {
                showDebugError_1.default(error, strings.errorLoadingDebugScriptUnknown, strings.errorLoadingUnknownTitle).catch(console.error);
            }
            else {
                ...
                showDebugError_1.default(error.error, errorText, title).catch(console.error);
            }
        });
    };
    ...
    DebugManager._getUrlErrorText = function (url, paramName) {
        ...
        return isMalformed
            ? sp_core_library_1.Text.format(strings.errorLoadingDebugScriptMalformed, url)
            : sp_core_library_1.Text.format(isHttps ? strings.errorLoadingDebugScriptHTTPS : strings.errorLoadingDebugScriptHTTP, paramName);
    };
