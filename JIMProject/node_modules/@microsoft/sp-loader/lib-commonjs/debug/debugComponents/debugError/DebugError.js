...
var strings = tslib_1.__importStar(require("./DebugError.resx"));
    ...
    DebugError.prototype.render = function () {
        return (React.createElement("div", { "data-automation-id": 'debugManifestErrorDialog', role: 'dialog' },
            React.createElement(Dialog_1.Dialog, { hidden: !this.state.isShown, dialogContentProps: {
                ...
                React.createElement("p", { className: DebugError_module_scss_1.default.detailText }, this.props.errorText || strings.debugManifestErrorDetail),
                React.createElement("p", { className: DebugError_module_scss_1.default.errorText }, this.props.innerError.toString()),
                React.createElement(Dialog_1.DialogFooter, null,
                    React.createElement(Button_1.PrimaryButton, { "data-automation-id": 'debugManifestErrorDismissButton', onClick: this._handleDismissClick }, strings.debugManifestErrorDismissButtonText)))));
    };
    return DebugError;
}(React.Component));
