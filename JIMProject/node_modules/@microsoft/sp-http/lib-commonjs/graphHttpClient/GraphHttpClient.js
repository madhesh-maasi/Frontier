...
var OAuthTokenProvider_1 = tslib_1.__importDefault(require("../oauthTokenProvider/OAuthTokenProvider"));
...
var SPHttpClientHelper_1 = tslib_1.__importDefault(require("../spHttpClient/SPHttpClientHelper"));
var GraphHttpClientConfiguration_1 = require("./GraphHttpClientConfiguration");
var GraphHttpClientContext_1 = tslib_1.__importDefault(require("./GraphHttpClientContext"));
...
var GraphHttpClient = /** @class */ (function () {
    ...
    GraphHttpClient.prototype._fetchWithInstrumentation = function (configuration, request) {
        return HttpClientHelper_1.default.fetchCore(configuration, request, this._serviceScope, this._fetchProvider, GraphHttpClient._className)
    ...
    Object.defineProperty(GraphHttpClient.prototype, "_cacheDataProvider", {
        ...
        get: function () {
            if (!this._cacheProvider) {
                this._cacheProvider = this._serviceScope.consume(CacheDataProviderService_1.getCacheDataProviderServiceKey())._provider;
            }
