...
var BatchedRequest_1 = tslib_1.__importDefault(require("./BatchedRequest"));
...
var SPHttpClientBatch = /** @class */ (function () {
    ...
    SPHttpClientBatch.prototype.fetch = function (url, configuration, options) {
        ...
        if (!this._webUrl) {
            ...
            // the first request.
            this._webUrl = SPHttpClientHelper_1.default.getWebUrlFromRequestUrl(requestUrl);
        }
    ...
    SPHttpClientBatch.prototype.execute = function () {
        ...
        return chain
            ...
            if (!response.ok) {
                var useStatusKillSwitch = !sp_core_library_1._SPKillSwitch.isActivated('3a61beed-a088-4f18-a950-f41aa36b9486'
                /* '04/22/2021', 'Return the status instead of status text' */
                );
                throw new Error('SPHttpClientBatch: The batch request failed: ' +
                    (useStatusKillSwitch ? response.status.toString() : response.statusText));
            }
            ...
            for (var i = 0; i < _this._batchedRequests.length; ++i) {
                ...
                request.resolvePromise(new SPHttpClientResponse_1.default(responses[i]));
            }
            return _this;
        })
