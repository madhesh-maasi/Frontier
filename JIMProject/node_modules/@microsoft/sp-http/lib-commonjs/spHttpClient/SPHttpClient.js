...
var SPHttpClient = /** @class */ (function () {
    ...
    SPHttpClient.prototype._fetch = function (url, configuration, options) {
        return SPHttpClientHelper_1.default.fetchCore(url, configuration, options, this._serviceScope, this._digestCache, this._fetchProvider, this._logSourceId);
    };
    Object.defineProperty(SPHttpClient.prototype, "_cacheDataProvider", {
        ...
        get: function () {
            if (!this._cacheProvider) {
                this._cacheProvider = this._serviceScope.consume(__1._getCacheDataProviderServiceKey())._provider;
            }
