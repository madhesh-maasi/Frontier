...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.fetch = function (url, configuration, options, cacheConfiguration) {
        ...
        var cacheKey = !sp_core_library_1._SPKillSwitch.isActivated('2d2088b1-9d64-4ff4-a6fa-7f8aa8511158' /* '8/3/2021', 'Use caller cacheConfiguration options' */)
            ? this._cacheDataProvider.getCacheKey(url, configuration, options, cacheConfiguration)
            : this._cacheDataProvider.getCacheKey(url, configuration, options);
