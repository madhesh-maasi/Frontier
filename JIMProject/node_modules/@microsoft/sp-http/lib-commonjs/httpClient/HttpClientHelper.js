...
var SDKVERSION_HEADER_KILLSWITCH = sp_core_library_1.Guid.parse('7eade7ed-629b-4db2-8837-1fde226c59ff');
var QOS_LOG_FAILURE_KILLSWITCH = sp_core_library_1.Guid.parse('065b3863-45bb-44c0-846e-5cd769f06683');
/**
...
var HttpClientHelper = /** @class */ (function () {
    ...
    HttpClientHelper.fetchCore = function (configuration, request, serviceScope, fetchProvider, logSource) {
        ...
        try {
            sp_diagnostics_1._TraceLogger.logVerbose(loggingSource, request.method + " " + request.url);
        }
        catch (error) {
        ...
        var alias;
        var componentId;
        if (sp_core_library_1._SPKillSwitch.isActivated(QOS_LOG_FAILURE_KILLSWITCH, '10/20/2020', 'Reduce HttpClientHelper.Fetch logging')) {
            qosMonitor = new sp_diagnostics_1._QosMonitor(HttpClientHelper.HTTP_CLIENT_CLASS_NAME_FETCH);
        }
        if (clientManifestData.manifest) {
            ...
            if (!sp_core_library_1._SPKillSwitch.isActivated(SDKVERSION_HEADER_KILLSWITCH, '10/22/2019', 'RemoveSdkVersionHeader')) {
        ...
        return fetchProvider
            ...
            if (!sp_core_library_1._SPKillSwitch.isActivated('05b38c8d-4659-4055-9348-7f15ab35b204'
