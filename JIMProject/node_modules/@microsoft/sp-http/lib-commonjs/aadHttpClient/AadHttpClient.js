...
var HttpClientResponse_1 = tslib_1.__importDefault(require("../httpClient/HttpClientResponse"));
...
var AadHttpClient = /** @class */ (function () {
    ...
    AadHttpClient.prototype.fetch = function (url, configuration, options) {
        ...
        return this._fetch(url, configuration, options, this._useCachedToken).then(function (originalResponse) {
            if (!sp_core_library_1._SPKillSwitch.isActivated('0cf10fc5-9dba-4929-9644-68aa50693e25'
     ...
     * Should only be called when _resourceUrl is passed in as a map between AppIds and servicePrincipalNames,
     * that is auto generated and populated into the field ApplicationAPIEndpoints in the generated client page context.
     *
     * @internal
     */
    AadHttpClient.prototype._prefetchTokens = function () {
        return this._aadTokenProvider._prefetchTokensAndWriteMapToStorage(this._resourceUrl);
    };
    AadHttpClient.prototype._fetch = function (url, configuration, options, useCachedToken) {
        ...
        return tokenFetchPromise.then(function (token) {
            ...
            if (!sp_core_library_1._SPKillSwitch.isActivated('784afa03-cdaa-4a5a-84a0-479d431cc639'
            ...
            return HttpClientHelper_1.default.fetchCore(configuration, new Request(url, options), _this._serviceScope, _this._fetchProvider, AadHttpClient._className).then(function (response) {
                if (!sp_core_library_1._SPKillSwitch.isActivated('0e4428bc-190b-4f77-9ed8-93de78c314db'
