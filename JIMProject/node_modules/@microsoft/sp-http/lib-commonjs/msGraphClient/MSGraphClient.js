...
var MSGraphClient = /** @class */ (function () {
    ...
    function MSGraphClient(serviceScope) {
        ...
        serviceScope.whenFinished(function () {
            ...
            if (!MSGraphClient._instance) {
                MSGraphClient._instance = _this._createGraphClientInstance(AadTokenProviders_1.default.configurable);
            }
        });
    }
    /**
    ...
    MSGraphClient.prototype.api = function (path, config) {
        ...
        MSGraphClient._instance.config = tslib_1.__assign(tslib_1.__assign({}, MSGraphClient._originalConfig), (config || {}));
