...
var TokenUtilityLogger = /** @class */ (function () {
    ...
    TokenUtilityLogger.prototype.logInfo = function (message) {
        sp_diagnostics_1._TraceLogger.logVerbose(TokenUtilityLogger.logSource, message);
    };
    TokenUtilityLogger.prototype.logError = function (message) {
        sp_diagnostics_1._TraceLogger.logError(TokenUtilityLogger.logSource, new Error(message));
    };
    TokenUtilityLogger.prototype.logWarning = function (message) {
        sp_diagnostics_1._TraceLogger.logVerbose(TokenUtilityLogger.logSource, 'Warning: ' + message);
    };
    TokenUtilityLogger.logSource = sp_diagnostics_1._LogSource.create('TokenUtility');
...
var OAuthUtilityContext = /** @class */ (function () {
    ...
    OAuthUtilityContext.prototype.qosMonitor = function () {
        return new sp_diagnostics_1._QosMonitor(OAuthUtilityContext.qosName);
    };
