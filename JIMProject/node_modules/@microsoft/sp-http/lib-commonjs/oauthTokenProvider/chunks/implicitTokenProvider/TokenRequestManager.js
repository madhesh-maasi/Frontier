...
exports.TokenRequestManager = void 0;
...
var TokenRequestManager = /** @class */ (function () {
    ...
    TokenRequestManager.isExpectedError = function (errorMessage) {
        ...
        return (AadErrorHandler_1.AadErrorHandler._doesAadErrorCodeExist(errorMessage, AadConstants_1.default.EXPECTED_AAD_ERRORS) ||
    ...
    TokenRequestManager._createResourceMetadata = function (resourceEndpoint) {
        return {
            ...
            state: sp_core_library_1.Guid.newGuid().toString(),
    ...
    TokenRequestManager.prototype.getToken = function (resourceUri, useLoginHint) {
        ...
        var tokenRequest = AadKillSwitches_1.AadKillSwitches.isUpdateTokenForImplicitTokenProviderEnabled()
            ? undefined
    ...
    TokenRequestManager.prototype._getToken = function (resourceUri, useLoginHint, resourceMetadata, attemptCount) {
        ...
        var acquireAccessTokenQosMonitor = new sp_diagnostics_1._QosMonitor('ImplicitTokenProvider.FetchAccessTokenSilent');
        ...
        return tokenRequest
            ...
            if (TokenRequestManager.isSuccessfulResponse(response)) {
                ...
                if (attemptCount < 1) {
                    ...
                    if (!sp_core_library_1._SPKillSwitch.isActivated('3d883034-d2f0-4034-8c1e-9ade277ceb6c' /* '8/5/2020', 'Retry Authentication' */) &&
                        response.errorDescription.indexOf(AadConstants_1.default.LOGIN_REQUIRED) > -1) {
    ...
    TokenRequestManager.prototype._handleAuthErrors = function (monitor, resourceUri, errorMessage, errorCode, extraData) {
        if (AadErrorHandler_1.AadErrorHandler._isInteractionRequired(errorMessage, errorCode)) {
            try {
                ...
                sessionStorage.setItem('SPORedirectTokenKey', TokenStorage_1.TokenStorage.getCacheKey(this._defaultConfiguration.aadUserId || '', this._defaultConfiguration.servicePrincipalId, TokenStorage_1.ACCESS_TOKEN_KEY, resourceUri));
                sessionStorage.setItem('SPORedirectExpirationKey', TokenStorage_1.TokenStorage.getCacheKey(this._defaultConfiguration.aadUserId || '', this._defaultConfiguration.servicePrincipalId, TokenStorage_1.EXPIRATION_KEY, resourceUri));
            }
            catch (e) {
                // If session storage is unavailable, SPFxSingleSignOn will redirect to window.location.host
            }
            sp_core_library_1._SPEventManager.instance.raiseEvent(AadTokenProvider_1.default._tokenAcquisitionEventId, new AadTokenProvider_1.TokenAcquisitionEventArgs(strings.additionalCredentialsWarning, this._getTokenRequestUrl(TokenRequestManager._createResourceMetadata(resourceUri), false, false)));
        }
...
exports.TokenRequestManager = TokenRequestManager;
