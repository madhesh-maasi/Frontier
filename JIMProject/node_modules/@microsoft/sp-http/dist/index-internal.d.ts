...
export declare class AadHttpClient {
    ...
    /* Excluded from this release type: _prefetchTokens */
    private _fetch;
}
...
export declare class AadTokenProvider implements IInternalAadTokenProvider {
    ...
    private static readonly _endpointIdUrlMappinglocalStorageKey;
    private static readonly _msGraphEndpointAppId;
    private static readonly _maxEndpointsToFetch;
    private static readonly _fetchUsingPrefetchedTokenTimeout;
    private static readonly _cachePersistenceTime;
    private static readonly _millisecondsToHourRatio;
    /**
    ...
    private _collectTokenPrefetchingTelemetry;
    private _utilizeTokenPrefetching;
    private _endpointToUrlList;
    private _endpointToUrlMapping;
    private _loggedGetToken;
    private _loggedGetTokenInternal;
    /* Excluded from this release type: __constructor */
    /**
    ...
    /* Excluded from this release type: _prefetchTokensAndWriteMapToStorage */
    /**
     ...
     */
    private _setResourceEndpointListFromStorage;
    /**
     * Any checks for SPPerfExperiments cannot be called in the constructor because the object is not yet intialized.
     */
    private _shouldUtilizeTokenPrefetching;
    private _setResourceEndpointMappingFromList;
    /**
     ...
     */
    private _getMappedAppIdIfPossible;
    private _isCachedMapExpired;
    private _applyTimeOut;
    /**
     ...
     */
    private _removeResourceEndpointFromListAndStorage;
    private _removeResourceEndpointFromMap;
}
 ...
 * @public
 */
export declare class BeforeRedirectEventArgs extends SPEventArgs {
    /**
...
/* Excluded from this release type: _prefetchAPIAccessTokens */
