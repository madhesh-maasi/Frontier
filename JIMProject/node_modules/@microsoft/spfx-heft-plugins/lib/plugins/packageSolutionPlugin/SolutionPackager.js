...
const WebpackConfigurationPlugin_1 = require("../webpackConfigurationPlugin/WebpackConfigurationPlugin");
...
class SolutionPackager {
    constructor(options) {
        ...
        this._webpackOutputFolderPaths = WebpackConfigurationPlugin_1.WebpackConfigurationPlugin.getSpfxWebpackFolders(this._buildFolder);
        this._terminal = options.terminal;
        this._emitError = options.emitError;
        this._emitWarning = options.emitWarning;
    }
    async packageSolutionAsync(production) {
        ...
        await createPackage_1.default(this._terminal, config, manifestMap);
    }
