...
function createSolutionXml(terminal, solution, customFeatureFilenames, resources, contentTypes) {
    ...
    const featuresXml = solution.features.map((feature) => createFeatureXml_1.default(terminal, feature, resources));
    ...
    if (includeClientAssets) {
        ...
        const clientSideFeatureXml = createFeatureXml_1.default(terminal, clientSideAssetsFeature, {
