...
export declare function getFiles(terminal: Terminal, cwd: string, globs: string, foundMessage?: string): Promise<IFile[]>;
/** Reads the list of relative path from a specified folder */
export declare function getRelativeFilePaths(terminal: Terminal, cwd: string, globs: string, foundMessage?: string): Promise<string[]>;
