...
function createFeatureXml(terminal, feature, resources, clientSideAssets, featureXmlFile = `feature_${feature.id}.xml`) {
    ...
    const assets = readSharepointAssets_1.readSharepointAssets(terminal, feature.assets, feature.id);
