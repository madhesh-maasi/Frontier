...
class DeployAzureStoragePlugin {
    constructor() {
        this.pluginName = "deploy-azure-storage-plugin" /* DeployAzureStoragePlugin */;
    }
    static async deployToAzure({ terminal, buildFolder, emitError, rigConfig, tryCreateContainer }) {
    ...
    apply(heftSession, heftConfiguration) {
        heftSession.registerAction({
            ...
            callback: async ({ skipTryCreateContainer }) => {
                ...
                await DeployAzureStoragePlugin.deployToAzure({
