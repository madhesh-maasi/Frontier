...
function _printHelperMessage(terminal, queryParameters) {
    const message = `For an improved debugging experience, please set the ` +
        ...
        ` testing.`;
    terminal.writeLine(colors_1.default.yellow(message));
    terminal.writeLine(_getAdvice());
    terminal.writeLine(`${colors_1.default.yellow('Debug query parameters:')} "${_concatenateQueryParams(queryParameters)}"`);
}
function _getAdvice() {
...
function _printDeployString(terminal, testingPageUrl, queryParams) {
    ...
    terminal.writeLine(`${colors_1.default.yellow('Test URL:')} ${testUrl}`);
}
/**
