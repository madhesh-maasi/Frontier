...
const getDevDeployContainerDirectoryName_1 = require("../../utilities/getDevDeployContainerDirectoryName");
...
class SpDevDeploy {
    constructor(options, configFileData) {
        ...
        this._options = {
            ...
            _additionalDirectoriesToInclude: [],
    ...
    static getDevDeployContainerDirectoryName() {
        return getDevDeployContainerDirectoryName_1.getDevDeployContainerDirectoryName();
    }
    ...
    _printDevDeployLink() {
        ...
        DevDeployLinkPrinter_1.printDevDeployLink({
            terminal: this._options.terminal,
