...
exports.ManifestPlugin = exports.SPFX_MANIFEST_RELEASE_VARIANT_SYMBOL = void 0;
 ...
 * @internal
 */
exports.SPFX_MANIFEST_RELEASE_VARIANT_SYMBOL = Symbol('spfx-manifest-release-variant');
/**
 * @internal
 */
class ManifestPlugin {
     ...
     * @internal
     */
    static _tryGetReleaseManifestVariant(asset) {
        return asset[exports.SPFX_MANIFEST_RELEASE_VARIANT_SYMBOL];
    }
    apply(compiler) {
            ...
            for (const bundleEntry of this._options.bundleEntries) {
                try {
                    ...
                    for (const [componentId, bundleComponent] of Object.entries(bundleEntry.components)) {
                        ...
                        const manifestAsset = emitAsset(`${componentId}.manifest.json`, serializedDebugManifest);
                        manifestAsset[exports.SPFX_MANIFEST_RELEASE_VARIANT_SYMBOL] = serializedReleaseManifest;
