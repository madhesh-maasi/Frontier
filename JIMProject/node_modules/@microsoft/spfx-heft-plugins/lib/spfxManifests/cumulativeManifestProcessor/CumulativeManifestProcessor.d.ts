...
import { IManifestsFileBuilderOptions } from '../manifestFileBuilder/ManifestsFileBuilder';
/**
 * @internal
 */
 ...
 * @internal
 */
export interface ICumulativeManifestEnvironmentOptions extends IManifestsFileBuilderOptions {
    rootPath: string;
