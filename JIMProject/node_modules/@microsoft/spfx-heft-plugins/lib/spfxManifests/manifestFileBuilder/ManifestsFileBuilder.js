...
class ManifestsFileBuilder {
    constructor(options) {
        ...
        this._manifestsFilePath =
            options.manifestsFilePath || path.join(__dirname, 'manifestsFile', 'manifestsFile.js');
    }
    async buildManifestsJs(manifestsArray, outputFilePath, azurePathOverride) {
        // Write the manifests.js file
        const webpackConfig = this._getManifestsFileWebpackConfig(manifestsArray, outputFilePath, azurePathOverride);
        try {
    ...
    _getManifestsFileWebpackConfig(manifestsArray, outputFilePath, deployedAssetPathOverride) {
            ...
            optimization: {
                ...
                minimizer: [
                    new module_minifier_plugin_1.ModuleMinifierPlugin({
                        minifier: new module_minifier_plugin_1.LocalMinifier({
                            terserOptions: {
                                compress: {
                                    passes: 1
                                },
