...
export declare class AzureUploader {
     ...
     */
    uploadFilesToAzureAsync(terminal: Terminal, files: IUploadableFile[], maxParallelism?: number, maxRetries?: number, retryDelayInMs?: number, onFileUploaded?: (serverPath: string) => void): Promise<void>;
