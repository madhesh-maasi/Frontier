...
import { IWebpackConfigurationWithDevServer } from '@rushstack/heft-webpack4-plugin';
...
export declare class _AzureUploader {
    ...
    static getStorageAccountUrl(storageAccountName: string): string;
    constructor(options: _IAzureUploaderOptionsForSas | _IAzureUploaderOptionsForKey);
    /**
     * Upload file to Azure
     */
    uploadFileToAzureAsync(terminal: Terminal | undefined, localFilename: string, serverFilename: string, blobHeaders?: BlobHTTPHeaders): Promise<void>;
    uploadToAzureAsync(terminal: Terminal, contents: string | Buffer, serverFilename: string, blobMetadata?: {
        [name: string]: string;
    }): Promise<void>;
    /**
     * Upload files to Azure
     */
    uploadFilesToAzureAsync(terminal: Terminal, files: _IUploadableFile[], maxParallelism?: number, maxRetries?: number, retryDelayInMs?: number, onFileUploaded?: (serverPath: string) => void): Promise<void>;
    ensureContainerExistsAsync(terminal: Terminal): Promise<void>;
 ...
 * @internal
 */
export declare class _CopyReleaseAssetsPlugin implements webpack.Plugin {
    private _options;
    constructor(options: _ICopyReleaseAssetsPluginOptions);
    apply(compiler: webpack.Compiler): void;
}
 ...
 * @internal
 */
declare class CustomizeWebpackConfigurationPlugin implements IHeftPlugin {
    readonly pluginName: string;
    apply(heftSession: HeftSession, heftConfiguration: HeftConfiguration): void;
    private _updateWebpackConfigurationAsync;
}

export declare const _CustomizeWebpackConfigurationPlugin: CustomizeWebpackConfigurationPlugin;
 ...
 * @internal
 */
export declare class _DeployAzureStoragePlugin implements IHeftPlugin {
    readonly pluginName: string;
    static deployToAzure({ terminal, buildFolder, emitError, rigConfig, tryCreateContainer }: _IDeployToAzureOptions): Promise<void>;
    apply(heftSession: HeftSession, heftConfiguration: HeftConfiguration): void;
}
 ...
 * @internal
 */
export declare interface _ICopyReleaseAssetsPluginOptions {
    releasePath: string;
    assetsFolderName?: string;
    manifestsFolderName?: string;
}
...
export declare class _LegacyExternals {
    ...
    private readonly _singleLocale;
    ...
    private _tryGetLegacyExternalsByName;
}
...
export declare class _ManifestsFileBuilder {
    ...
    buildManifestsJs(manifestsArray: IClientSideComponentManifest[], outputFilePath: string, azurePathOverride?: string): Promise<void>;
...
export declare const enum PluginNames {
    ...
    SpfxHeftExtensionsPlugin = "spfx-heft-extensions-plugin",
    ...
    PackageSolutionPlugin = "package-solution-plugin",
    ThirdPartyExternalsPlugin = "third-party-externals-plugin",
    DeployAzureStoragePlugin = "deploy-azure-storage-plugin"
}
...
export declare class _SolutionPackager {
    ...
    packageSolutionAsync(production: boolean): Promise<void>;
