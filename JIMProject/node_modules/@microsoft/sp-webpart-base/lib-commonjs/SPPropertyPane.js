...
function PropertyPaneCustomField(properties) {
    return PropertyPaneCustomField_1.PropertyPaneCustomField(properties);
}
...
function PropertyPaneButton(targetProperty, properties) {
    return PropertyPaneButton_1.PropertyPaneButton(targetProperty, properties);
}
...
function PropertyPaneCheckbox(targetProperty, properties) {
    return PropertyPaneCheckbox_1.PropertyPaneCheckbox(targetProperty, properties);
}
...
function PropertyPaneChoiceGroup(targetProperty, properties) {
    return PropertyPaneChoiceGroup_1.PropertyPaneChoiceGroup(targetProperty, properties);
}
...
function PropertyPaneDropdown(targetProperty, properties) {
    return PropertyPaneDropdown_1.PropertyPaneDropdown(targetProperty, properties);
}
...
function PropertyPaneDynamicField(targetProperty, properties) {
    return PropertyPaneDynamicField_1.PropertyPaneDynamicField(targetProperty, properties);
}
...
function PropertyPaneDynamicFieldSet(properties) {
    return PropertyPaneDynamicFieldSet_1.PropertyPaneDynamicFieldSet(properties);
}
...
function PropertyPaneHorizontalRule() {
    return PropertyPaneHorizontalRule_1.PropertyPaneHorizontalRule();
}
...
function PropertyPaneLabel(targetProperty, properties) {
    return PropertyPaneLabel_1.PropertyPaneLabel(targetProperty, properties);
}
...
function PropertyPaneLink(targetProperty, properties) {
    return PropertyPaneLink_1.PropertyPaneLink(targetProperty, properties);
}
...
function PropertyPaneSlider(targetProperty, properties) {
    return PropertyPaneSlider_1.PropertyPaneSlider(targetProperty, properties);
}
...
function PropertyPaneTextField(targetProperty, properties) {
    return PropertyPaneTextField_1.PropertyPaneTextField(targetProperty, properties);
}
...
function PropertyPaneToggle(targetProperty, properties) {
    return PropertyPaneToggle_1.PropertyPaneToggle(targetProperty, properties);
}
...
function PropertyPaneDynamicTextField(targetProperty, properties) {
    return PropertyPaneDynamicTextField_1.PropertyPaneDynamicTextField(targetProperty, properties);
}
