...
var WebPartLoadDataCollector = /** @class */ (function () {
    ...
    WebPartLoadDataCollector.collect = function (manifest, webPartTag, pageContext) {
        var getTime = function (key) {
            return (sp_telemetry_1._PerformanceLogger.readComponentBreakdown(webPartTag, key) ||
                sp_telemetry_1._PerformanceLogger.readTempData(webPartTag + "." + key));
        };
        ...
        var webpartPerfFlights = !KillSwitches_1.default._isWebpartExperimentKSActivated()
            ? sp_telemetry_1._PerformanceLogger.getWebpartFlightsAndExperiments(webPartTag)
            : undefined;
        ...
        if (!KillSwitches_1.isAddTeamsHostDataKsActivated()) {
    ...
    WebPartLoadDataCollector._getSyncRenderTime = function (layoutID, getTime) {
        ...
        if (!KillSwitches_1.default.isAddSyncRenderTimeKSActivated()) {
            syncRenderTime = Math.floor(getTime('syncRender') - getTime('getDataComplete'));
            if (!KillSwitches_1.default.isExclusiveRenderTimeForBaseCollectionWebPartKSActivated()) {
...
exports.default = WebPartLoadDataCollector;
