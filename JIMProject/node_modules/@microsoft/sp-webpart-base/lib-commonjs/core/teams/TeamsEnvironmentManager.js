...
var TeamsEnvironmentManager = /** @class */ (function () {
    ...
    TeamsEnvironmentManager.initialize = function () {
        if (!sp_core_library_1._BrowserUtilities.isTeamsHosted() || TeamsEnvironmentManager.teamsContext) {
        ...
        return Promise.resolve().then(function () { return __importStar(require('@microsoft/teams-js' /* webpackChunkName: 'spfx-core-teamsenv-teamsJs' */)); }).then(function (teamsJS) {
            teamsJS.initialize();
