...
var ClientSideWebPartStatusRenderer = /** @class */ (function () {
    ...
    ClientSideWebPartStatusRenderer.prototype.displayLoadingIndicator = function (domElement, loadingMessage, timeout, clearDomElementCallback) {
        var isKSActivated = KillSwitches_1.isClearLoadingIndicatorKSActivated();
        if (!isKSActivated) {
            this._logEngagement(domElement, 'displayLoadingIndicator');
        }
        this._createLoadingIndicator(domElement, loadingMessage, timeout, undefined, undefined, undefined, isKSActivated ? undefined : clearDomElementCallback);
    };
    /**
     ...
     * @internal
     */
    ClientSideWebPartStatusRenderer.prototype._displayLoadingIndicator = function (domElement, loadingMessage, performanceLogEventName, reservedHeight, isInternal, timeout, clearDomElementCallback) {
        this._createLoadingIndicator(domElement, loadingMessage, reservedHeight, timeout, performanceLogEventName, isInternal, clearDomElementCallback);
    };
    /**
     ...
     */
    ClientSideWebPartStatusRenderer.prototype.renderError = function (domElement, error, clearDomElementCallback) {
        sp_core_library_1.Validate.isNotNullOrUndefined(domElement, 'domElement');
        ...
        if (error instanceof sp_core_library_1.SPError) {
            ...
            var callStack = stack
                ? sp_core_library_1.Text.format(strings.WebpartErrorCallStackText, newLineSeparator, stack)
                : '';
            errorText = sp_core_library_1.Text.format(strings.WebpartErrorErrorText, newLineSeparator, "" + (vanillaError.message || error), callStack);
        }
        var cacheEntry = this._getCacheEntry(domElement);
        ...
        if (divErr) {
            ...
            if (!isKSActivated && clearDomElementCallback) {
    ...
    ClientSideWebPartStatusRenderer.prototype._createLoadingIndicator = function (domElement, loadingMessage, reservedHeight, timeout, performanceLogEventName, isInternal, clearDomElementCallback) {
        var _this = this;
        sp_core_library_1.Validate.isNotNullOrUndefined(domElement, 'domElement');
        ...
        cacheEntry.loadingTimer = window.setTimeout(function () {
            if (performanceLogEventName && isInternal) {
                ...
                cacheEntry.loadingTimer = window.setTimeout(function () {
                    _this._showLoadingIndicator(domElement, loadingMessage, reservedHeight, performanceLogEventName, isInternal, clearDomElementCallback);
                }, additionalTimeOut);
            }
            else {
                _this._showLoadingIndicator(domElement, loadingMessage, reservedHeight, performanceLogEventName, isInternal, clearDomElementCallback);
     ...
     * parts, e.g., 'WebPart.NewsWebPart.8dd9dec2-c6b3-4d4a-819e-2a5431e901f2'.
     */
    ClientSideWebPartStatusRenderer.prototype._showLoadingIndicator = function (domElement, loadingMessage, reservedHeight, performanceLogEventName, isInternal, clearDomElementCallback) {
        if (performanceLogEventName && isInternal) {
        ...
        this._renderLoadingIndicator(domElement, loadingMessage, reservedHeight, performanceLogEventName, clearDomElementCallback);
    };
    ClientSideWebPartStatusRenderer.prototype._renderLoadingIndicator = function (domElement, loadingMessage, reservedHeight, performanceLogEventName, clearDomElementCallback) {
        if (!this._activeIndicatorCache.has(domElement)) {
            return;
        }
        var cacheEntry = this._getCacheEntry(domElement);
        ...
        cacheEntry.placeholder = this._createLoadingIndicatorElement(domElement, loadingMessage, reservedHeight, performanceLogEventName, clearDomElementCallback);
    };
    ...
    ClientSideWebPartStatusRenderer.prototype._createLoadingIndicatorElement = function (domElement, loadingMessage, reservedHeight, performanceLogEventName, clearDomElementCallback) {
        if (clearDomElementCallback) {
            clearDomElementCallback(domElement);
        }
        this._clearChildren(domElement);
        var titleMessage = sp_core_library_1.Text.format(strings.LoadingStatus, loadingMessage);
    ...
    ClientSideWebPartStatusRenderer.prototype._logEngagement = function (domElement, logFeature) {
        ...
        sp_telemetry_1._EngagementLogger.log({
            name: "ClientSideWebPartStatusRenderer." + logFeature,
            isIntentional: true,
            extraData: {
