...
var BaseWebPart = /** @class */ (function (_super) {
    ...
    BaseWebPart.prototype._getPropertyPaneData = function (isDetails, context) {
        ...
        return this._loadPropertyPaneResources().then(function () {
            ...
            var shouldAddAudiencePicker = Flights_1.isMeeDashboardEnabled() && _this.context.manifest.id === ACE_WEBPART_MANIFEST_ID;
    ...
    BaseWebPart.prototype._onPropertyPaneFieldChanged = function (propertyPath, newValue /* tslint:disable-line:no-any */, fieldType) {
        ...
        if (!lodash.isEqual(oldValue, newValue) ||
            ...
            if (oldValue instanceof sp_component_base_1.DynamicProperty && !(newValue instanceof sp_component_base_1.DynamicProperty)) {
                var newDynamicProperty = new sp_component_base_1.DynamicProperty(// tslint:disable-line:no-any
            ...
            if (Flights_1.isMeeDashboardEnabled() && propertyPath === AUDIENCES_PROPERTY) {
    ...
    BaseWebPart.prototype._getDefaultAccessibleTitle = function () {
        return sp_core_library_1.Text.format(strings.GenericAccessibleLabelTemplate, this.title);
    };
    /**
    ...
    BaseWebPart.prototype._reInstateServerProcessedData = function (deserializedProperties, serverProcessedContent) {
        ...
        if (Flights_1.isVivaDashboardImagePerfEnabled()) {
            ...
            configuration.pages[0].groups.push({
                ...
                groupFields: [
                    audienceFormService.renderAudienceFormPropertyPaneField({
                        ...
                        limit: 50,
                        webPartPropertyName: AUDIENCES_PROPERTY,
                        helpLink: 'https://go.microsoft.com/fwlink/?linkid=2155166',
                        tooltipText: strings.AudiencePickerTooltip
                    })
                ]
            });
        }
    ...
    BaseWebPart.prototype._serialize = function () {
        ...
        if (!KillSwitches_1.isAllowEmptyPropertyNameKSActivated() && lodash.has(properties, '')) {
    ...
    BaseWebPart.prototype._serializeDynamicData = function (serializedData) {
        ...
        var key = lodash.findKey(props, { __type: sp_component_base_1.DynamicProperty._TYPE_NAME });
        while (key) {
        ...
        if (data.dynamicDataPaths) {
            for (var path in data.dynamicDataPaths) {
                if (data.dynamicDataPaths.hasOwnProperty(path)) {
                    var dynamicProperty = new sp_component_base_1.DynamicProperty(// tslint:disable-line:no-any
                    this.context.dynamicDataProvider, (function () {
                        _this._dynamicPropertyRefresh();
                    }).bind(this));
                ...
                if (!(propValue instanceof sp_component_base_1.DynamicProperty)) {
                    ...
                    switch (metadata.dynamicPropertyType) {
                        ...
                        case 'object':
                            ...
                            break;
                        default:
                            dynamicProperty = new sp_component_base_1.DynamicProperty(// tslint:disable-line:no-any
