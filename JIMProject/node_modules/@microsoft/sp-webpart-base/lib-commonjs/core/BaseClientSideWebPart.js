...
var BaseClientSideWebPart = /** @class */ (function (_super) {
    ...
    BaseClientSideWebPart.prototype._internalInitialize = function (webPartContext, addedFromPersistedData, mode) {
        ...
        if (!KillSwitches_1.isAutomaticThemeSupportInBaseClientSideWebPartKSActivated()) {
    ...
    BaseClientSideWebPart.prototype.renderCompleted = function (error) {
        if (!KillSwitches_1.isAllowProactiveRenderFailureKsActivated() && error) {
    ...
    BaseClientSideWebPart.prototype.onDisplayModeChanged = function (oldDisplayMode) {
        ...
        if (!sp_core_library_1._SPKillSwitch.isActivated(sp_core_library_1.Guid.parse('222961df-4439-412b-9e41-2e659ae18ab6'), '5/11/2018', 'FirstRenderPromises')) {
    ...
    BaseClientSideWebPart.prototype.renderError = function (error) {
        ...
        if (this.displayMode === sp_core_library_1.DisplayMode.Edit &&
            ...
            var errorDetails = {
                errorCode: "WebPartBase " + this.context.manifest.alias + " Failure",
                errorMessage: error.message,
                errorScenario: 'Render'
            };
            sp_edit_customer_promise_1._logFailuresForEditCustomerPromise(errorDetails, this.context.serviceScope);
        }
    ...
    BaseClientSideWebPart.prototype._onInViewport = function () {
        ...
        initPromise
            ...
            var renderPromise = getDataPromise.then(function () {
                ...
                var isAsyncTimerKSActivated = KillSwitches_1.isMoveAsyncTimerKSActivated();
    ...
    BaseClientSideWebPart.prototype._renderWithAccessibleTitle = function () {
        sp_telemetry_1._PerformanceLogger.devMark("webpart(" + this.context.webPartTag + ")._renderWithAccessibleTitle");
        this.render();
    ...
    BaseClientSideWebPart.prototype._handleAsyncRenderFailed = function (error) {
        if (KillSwitches_1.clearTimerWhenRenderFailKSActivated() || this._asyncRenderGuardTimer) {
            if (!KillSwitches_1.clearTimerWhenRenderFailKSActivated()) {
                this._clearAsyncRenderGuardTimer();
            }
    ...
    BaseClientSideWebPart.prototype._resolveOrRejectOnRenderPromise = function (error) {
        ...
        sp_telemetry_1._PerformanceLogger.devMark("webpart(" + this.context.webPartTag + ").complete");
        if (!KillSwitches_1.isAllowProactiveRenderFailureKsActivated() && error) {
            ...
            if (this._renderPromiseResolver) {
                if (!KillSwitches_1.default.isResolveRenderTimeActivated()) {
                    this._renderPromiseResolver(sp_telemetry_1._PerformanceLogger.now());
                }
                else {
