...
var QosMonitorShareFailureWithCP = /** @class */ (function (_super) {
    ...
    function QosMonitorShareFailureWithCP(scenarioName, copyToEngagement, extraDataForCustomerPromise) {
        ...
        var _this = _super.call(this, scenarioName, copyToEngagement) || this;
    ...
    QosMonitorShareFailureWithCP.prototype.writeUnexpectedFailure = function (tagNameSuffix, ex, extraData // tslint:disable-line:no-any
        ...
        this._logCustomerPromiseFailure((ex === null || ex === void 0 ? void 0 : ex.message) || 'DefaultErrorMessage', tagNameSuffix, QosResultType_1.QosResultType.Failure, (extraData === null || extraData === void 0 ? void 0 : extraData.pageType) ? extraData.pageType : undefined);
    };
    /**
    ...
    QosMonitorShareFailureWithCP.prototype.writeExpectedFailure = function (tagNameSuffix, ex, extraData // tslint:disable-line:no-any
        ...
        this._logCustomerPromiseFailure((ex === null || ex === void 0 ? void 0 : ex.message) || 'DefaultErrorMessage', tagNameSuffix, QosResultType_1.QosResultType.ExpectedFailure, (extraData === null || extraData === void 0 ? void 0 : extraData.pageType) ? extraData.pageType : undefined);
    };
    /**
     ...
     */
    QosMonitorShareFailureWithCP.prototype._logCustomerPromiseFailure = function (errorMessage, errorScenario, resultType, pageType) {
