...
var QosMonitor = /** @class */ (function () {
    ...
    function QosMonitor(scenarioName, copyToEngagement) {
        ...
        this._qosResultTypeValue = (_a = {},
            ...
            _a);
        sp_core_library_1.Validate.isNonemptyString(scenarioName, 'scenarioName');
        this._id = sp_core_library_1.Guid.newGuid().toString();
    ...
    QosMonitor.prototype._shouldSkip = function (result) {
        if (this._hasEnded && this._endResult !== undefined) {
            var message = sp_core_library_1.Text.format(QosMonitor.qosMonitorHasEndedErrorString, this.name, this._qosResultTypeValue[this._endResult], this._qosResultTypeValue[result]);
