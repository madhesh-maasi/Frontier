...
var setPageExtraData_1 = require("../../extraData/setPageExtraData");
/**
 * Engagement logging
...
var EngagementLogger = /** @class */ (function () {
    ...
    EngagementLogger._addContextData = function (data) {
        if (DiagnosticsSettingsManager_1.default.isInitialized) {
            var _a = DiagnosticsSettingsManager_1.default.settings, listId = _a.listId, listItemUniqueId = _a.listItemUniqueId, siteId = _a.siteId, webId = _a.webId;
            data.siteId = siteId;
            data.webId = webId;
            if (listId) {
                data.listId = listId;
    ...
    EngagementLogger._appendExtraData = function (data) {
        if (DiagnosticsSettingsManager_1.default.isInitialized) {
            var contextInfo = DiagnosticsSettingsManager_1.default.settings.contextInfo;
            if (contextInfo) {
                if (!data.extraData) {
                    data.extraData = {};
                }
                setPageExtraData_1.setPageExtraData(contextInfo, data.extraData);
            }
        }
    };
    EngagementLogger._logManager = new LogManager_1.default();
