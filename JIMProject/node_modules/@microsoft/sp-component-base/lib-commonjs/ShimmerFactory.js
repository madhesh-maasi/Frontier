...
var shimmer_module_scss_1 = tslib_1.__importDefault(require("./styles/shimmer.module.scss"));
...
var ShimmerFactory = /** @class */ (function () {
    ...
    ShimmerFactory.createShimmer = function (width, height, componentTag, loadingMessage, containerMargin) {
        ...
        shimmerContainerDiv.className = shimmer_module_scss_1.default.shimmerContainer;
        ...
        var className = shimmer_module_scss_1.default.shimmerElementFill;
...
exports.default = ShimmerFactory;
