...
var DynamicDataSourceManager = /** @class */ (function () {
    ...
    DynamicDataSourceManager.prototype.updateMetadata = function (metadata) {
        ...
        sp_lodash_subset_1.merge(this._src.metadata, metadata);
    };
    ...
    DynamicDataSourceManager.prototype._allowedEvents = function () {
        return this._callableFunctions.allowedEvents
            ? sp_lodash_subset_1.cloneDeep(this._callableFunctions.allowedEvents())
            : undefined;
    };
    /**
    ...
    DynamicDataSourceManager.prototype._getPropertyDefinitions = function () {
        return sp_lodash_subset_1.cloneDeep(this._callableFunctions.getPropertyDefinitions());
    };
    /**
    ...
    DynamicDataSourceManager.prototype._getPropertyValue = function (propertyId) {
        ...
        try {
            ...
            qosMonitor.writeSuccess(tslib_1.__assign(tslib_1.__assign({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, propertyValue: propertyValue,
                propertyId: propertyId }));
            return sp_lodash_subset_1.cloneDeep(propertyValue);
        }
        catch (error) {
    ...
    DynamicDataSourceManager.prototype._getAnnotatedPropertyValue = function (propertyId) {
        ...
        if (getAnnotatedPropertyValue) {
            ...
            try {
                ...
                qosMonitor.writeSuccess(tslib_1.__assign(tslib_1.__assign({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, annotatedPropertyValue: annotatedPropertyValue,
                    propertyId: propertyId }));
            }
            catch (error) {
    ...
    DynamicDataSourceManager.prototype._assertValidEvent = function (eventName) {
        if (!this._allowedEvents() || sp_lodash_subset_1.findIndex(this._allowedEvents(), { name: eventName }) === -1) {
            throw new Error(sp_core_library_1.Text.format(strings.InvalidEvent, eventName, this._src.metadata.title));
        }
    };
