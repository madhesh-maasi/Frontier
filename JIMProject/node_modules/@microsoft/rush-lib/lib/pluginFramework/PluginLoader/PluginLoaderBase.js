...
class PluginLoaderBase {
    ...
    getCommandLineConfiguration() {
        ...
        if (!commandLineJsonFilePath || !node_core_library_1.FileSystem.exists(commandLineJsonFilePath)) {
            return undefined;
        }
        const commandLineConfiguration = CommandLineConfiguration_1.CommandLineConfiguration.loadFromFileOrDefault(commandLineJsonFilePath);
...
PluginLoaderBase._jsonSchema = node_core_library_1.JsonSchema.fromFile(path.join(__dirname, '../../schemas/rush-plugin-manifest.schema.json'));
