...
class AutoinstallerPluginLoader extends PluginLoaderBase_1.PluginLoaderBase {
    constructor(options) {
        super(options);
        this._autoinstaller = new Autoinstaller_1.Autoinstaller(options.pluginConfiguration.autoinstallerName, this._rushConfiguration);
    ...
    _getManifestPath() {
        return path.join(AutoinstallerPluginLoader.getPluginAutoinstallerStorePath(this._autoinstaller), this.packageName, RushConstants_1.RushConstants.rushPluginManifestFilename);
    }
    _getCommandLineJsonFilePath() {
        return path.join(AutoinstallerPluginLoader.getPluginAutoinstallerStorePath(this._autoinstaller), this.packageName, this.pluginName, RushConstants_1.RushConstants.commandLineFilename);
    }
}
