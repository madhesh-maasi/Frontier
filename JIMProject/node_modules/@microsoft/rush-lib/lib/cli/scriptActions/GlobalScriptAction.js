...
class GlobalScriptAction extends BaseScriptAction_1.BaseScriptAction {
    ...
    async _prepareAutoinstallerName() {
        const autoInstaller = new Autoinstaller_1.Autoinstaller(this._autoinstallerName, this.rushConfiguration);
    ...
    _expandShellCommandWithTokens(shellCommand, tokenContext) {
        ...
        for (const [token, tokenReplacement] of Object.entries(tokenContext)) {
            expandedShellCommand = node_core_library_1.Text.replaceAll(expandedShellCommand, `<${token}>`, tokenReplacement);
        }
