        ...
        for (const parameter of this.command.associatedParameters) {
            ...
            switch (parameter.parameterKind) {
                ...
                case 'string':
                    ...
                    break;
                default:
                    throw new Error(`${RushConstants_1.RushConstants.commandLineFilename} defines a parameter "${parameter.longName}" using an unsupported parameter kind "${parameter.parameterKind}"`);
            }
