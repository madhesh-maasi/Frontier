...
class InitAction extends BaseRushAction_1.BaseConfiglessRushAction {
    ...
    _copyTemplateFile(sourcePath, destinationPath) {
        const destinationFileExists = node_core_library_1.FileSystem.exists(destinationPath);
        if (!this._overwriteParameter.value) {
        ...
        const outputLines = [];
        const lines = node_core_library_1.FileSystem.readFile(sourcePath, { convertLineEndings: node_core_library_1.NewlineKind.Lf }).split('\n');
        ...
        // Write the output
        node_core_library_1.FileSystem.writeFile(destinationPath, outputLines.join(os.EOL), {
