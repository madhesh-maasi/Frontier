...
class AsyncRecycler {
    ...
    moveAllItemsInFolder(folderPath, membersToExclude) {
        ...
        for (const memberPath of node_core_library_1.FileSystem.readFolderItemNames(resolvedFolderPath, { absolutePaths: true })) {
    ...
    deleteAll() {
        ...
        if (os.platform() === 'win32') {
            ...
            for (const filename of node_core_library_1.FileSystem.readFolderItemNames(this.recyclerFolder)) {
