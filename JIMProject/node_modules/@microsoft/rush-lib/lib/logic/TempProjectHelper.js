        ...
        const tarOptions = {
            ...
            filter: (path, stat) => {
                if (!this._rushConfiguration.experimentsConfiguration.configuration.noChmodFieldInTarHeaderNormalization) {
                    stat.mode =
                        (stat.mode & ~0x1ff) | node_core_library_1.PosixModeBits.AllRead | node_core_library_1.PosixModeBits.UserWrite | node_core_library_1.PosixModeBits.AllExecute;
                }
                return true;
            }
        };
        // create the new tarball
        tar.create(tarOptions, [node_core_library_1.FileConstants.PackageJson]);
    }
    /**
