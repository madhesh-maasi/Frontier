...
class VersionMismatchFinderCommonVersions extends VersionMismatchFinderEntity_1.VersionMismatchFinderEntity {
    ...
    addOrUpdateDependency(packageName, newVersion, dependencyType) {
        if (dependencyType !== PackageJsonEditor_1.DependencyType.Regular) {
            throw new Error(`${RushConstants_1.RushConstants.commonVersionsFilename} only accepts "${PackageJsonEditor_1.DependencyType.Regular}" dependencies`);
        }
    ...
    _getPackageJsonDependency(dependencyName, version) {
        return new PackageJsonEditor_1.PackageJsonDependency(dependencyName, version, PackageJsonEditor_1.DependencyType.Regular, () => this.addOrUpdateDependency(dependencyName, version, PackageJsonEditor_1.DependencyType.Regular));
    }
}
