...
class BaseInstallManager {
    ...
    _installGitHooks() {
        ...
        if (node_core_library_1.FileSystem.exists(hookSource) && hookDestination) {
            const allHookFilenames = node_core_library_1.FileSystem.readFolderItemNames(hookSource);
            ...
            if (hookFilenames.length > 0) {
                ...
                if (!git.isHooksPathDefault()) {
                    const color = this.options.bypassPolicy ? safe_1.default.yellow : safe_1.default.red;
                    console.error(color([
                        ' ',
                ...
                for (const filename of filteredHookFilenames) {
                    ...
                    node_core_library_1.PosixModeBits.UserRead | node_core_library_1.PosixModeBits.UserExecute);
                }
