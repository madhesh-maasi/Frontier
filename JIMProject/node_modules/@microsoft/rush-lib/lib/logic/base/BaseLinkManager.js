...
class BaseLinkManager {
    ...
    static _createSymlink(options) {
        ...
        if (EnvironmentConfiguration_1.EnvironmentConfiguration.absoluteSymlinks) {
            ...
            targetPath = path.relative(node_core_library_1.FileSystem.getRealPath(newLinkFolder), options.linkTargetPath);
        }
    ...
    static _createSymlinksForDependencies(localPackage) {
        ...
        if (localPackage.children.length === 0) {
            ...
            for (const filename of node_core_library_1.FileSystem.readFolderItemNames(localPackage.symlinkTargetFolderPath)) {
