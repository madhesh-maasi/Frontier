 ...
 * incremental state.
 */
export declare class ProjectTaskRunner extends BaseTaskRunner {
    readonly name: string;
    readonly isSkipAllowed: boolean;
    ...
    constructor(options: IProjectTaskRunnerOptions);
...
//# sourceMappingURL=ProjectTaskRunner.d.ts.map