...
exports.convertSlashesForWindows = exports.ProjectTaskRunner = void 0;
 ...
 * incremental state.
 */
class ProjectTaskRunner extends BaseTaskRunner_1.BaseTaskRunner {
    constructor(options) {
        super();
    ...
    async _executeTaskAsync(context) {
        ...
        try {
            ...
            if (this._isCacheReadAllowed) {
                const projectBuildCache = await this._tryGetProjectBuildCacheAsync(terminal, trackedFiles, context.repoCommandLineConfiguration);
            ...
            if (taskIsSuccessful && projectDeps) {
                ...
                const projectBuildCache = await this._tryGetProjectBuildCacheAsync(terminal, trackedFiles, context.repoCommandLineConfiguration);
                const setCacheEntryPromise = projectBuildCache === null || projectBuildCache === void 0 ? void 0 : projectBuildCache.trySetCacheEntryAsync(terminal);
    ...
    async _tryGetProjectBuildCacheAsync(terminal, trackedProjectFiles, commandLineConfiguration) {
        var _a;
                ...
                if (projectConfiguration) {
                    if ((_a = projectConfiguration.cacheOptions) === null || _a === void 0 ? void 0 : _a.disableBuildCache) {
                        ...
                        if (commandOptions === null || commandOptions === void 0 ? void 0 : commandOptions.disableBuildCache) {
                            ...
                            const projectOutputFolderNames = projectConfiguration.projectOutputFolderNamesForPhases.get(this._phase.name) || [];
...
exports.ProjectTaskRunner = ProjectTaskRunner;
/**
...
//# sourceMappingURL=ProjectTaskRunner.js.map