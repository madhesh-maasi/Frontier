...
class TaskCollection {
    ...
    addTask(taskRunner) {
        ...
        const task = new Task_1.Task(taskRunner, TaskStatus_1.TaskStatus.Ready);
    ...
    getOrderedTasks() {
        ...
        const queue = [...this._tasks.values()];
        // Sort the queue in descending order, nothing will mess with the order
        node_core_library_1.Sort.sortBy(queue, (task) => -task.criticalPathLength);
        return queue;
    }
    /**
