...
class PnpmLinkManager extends BaseLinkManager_1.BaseLinkManager {
    ...
    async _linkProjects() {
        if (this._rushConfiguration.projects.length > 0) {
            ...
            const pnpmShrinkwrapFile = PnpmShrinkwrapFile_1.PnpmShrinkwrapFile.loadFromFile(this._rushConfiguration.tempShrinkwrapFilename);
    ...
    async _linkProject(project, pnpmShrinkwrapFile) {
        ...
        const packageJsonFilename = path.join(extractedFolder, node_core_library_1.FileConstants.PackageJson);
        ...
        await (0, link_bins_1.default)(projectFolder, projectBinFolder, {
