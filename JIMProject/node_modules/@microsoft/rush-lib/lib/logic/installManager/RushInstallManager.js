    ...
    async prepareCommonTempAsync(shrinkwrapFile) {
        ...
        for (const rushProject of sortedRushProjects) {
            ...
            for (const dependency of packageJson.dependencyList) {
                ...
                if (dependency.dependencyType === PackageJsonEditor_1.DependencyType.Optional) {
            ...
            const tempPackageJsonFilename = path.join(tempProjectFolder, node_core_library_1.FileConstants.PackageJson);
