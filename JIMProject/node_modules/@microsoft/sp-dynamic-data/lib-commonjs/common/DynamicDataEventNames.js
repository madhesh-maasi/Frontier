...
var DynamicDataEventNames = /** @class */ (function () {
    ...
    DynamicDataEventNames.getAllPropertiesChangedEventName = function (sourceId) {
        return "" + DynamicDataEventConstants_1.ALL_PROPERTIES_EVENT_PREFIX + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + sourceId;
    };
    /**
    ...
    DynamicDataEventNames.getAnyPropertyChangedEventName = function (sourceId) {
        return "" + DynamicDataEventConstants_1.ANY_PROPERTY_EVENT_PREFIX + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + sourceId;
    };
    /**
    ...
    DynamicDataEventNames.getPropertyChangedEventName = function (sourceId, propertyId) {
        return "" + this.getPropertyChangedEventPrefix(sourceId) + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + propertyId;
    };
    /**
    ...
    DynamicDataEventNames.getPropertyChangedEventPrefix = function (sourceId) {
        return "" + DynamicDataEventConstants_1.PROPERTY_EVENT_PREFIX + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + sourceId;
    };
    /**
    ...
    DynamicDataEventNames.getPropertyValueEventName = function (sourceId, propertyId, isAnnotated) {
        ...
        return "" + scenario + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + sourceId + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + propertyId;
    };
    /**
    ...
    DynamicDataEventNames.getPropertyDefintionsEventName = function (sourceId) {
        return "" + DynamicDataEventConstants_1.GET_PROPERTY_DEFINITIONS + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + sourceId;
    };
    /**
     * Returns the event name used to publish and consume the event to request and receive the
    ...
    DynamicDataEventNames.getAllowedEventsEventName = function (sourceId) {
        return "" + DynamicDataEventConstants_1.GET_ALLOWED_EVENTS + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + sourceId;
    };
    /**
    ...
    DynamicDataEventNames.getNativeSourceApiEventName = function () {
        return "" + DynamicDataEventConstants_1.NATIVE_SOURCE_API_EVENT;
    };
    DynamicDataEventNames.getDynamicDataManagerExceptionEventName = function (sourceId) {
        return "" + DynamicDataEventConstants_1.DYNAMICDATAMANAGER_EXCEPTION + DynamicDataEventConstants_1.EVENT_NAME_SEPARATOR + sourceId;
    };
