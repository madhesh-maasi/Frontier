...
var DynamicDataUtilities_1 = require("./common/DynamicDataUtilities");
/**
...
var PageContextDataSource = /** @class */ (function () {
    function PageContextDataSource(serviceScope) {
        ...
        this._serviceScope.whenFinished(function () {
            _this._dynamicDataManager = serviceScope.consume(DynamicDataUtilities_1.DynamicDataUtilities.IDynamicDataManagerServiceKey);
    ...
    PageContextDataSource.prototype.getPropertyDefinitions = function () {
        ...
        return sp_lodash_subset_1.cloneDeep(retVal);
    };
    /**
    ...
    PageContextDataSource.prototype.getPropertyValue = function (propertyId) {
        if (this._propertyDefinitions[propertyId]) {
            ...
            return sp_lodash_subset_1.cloneDeep(this._propertyDefinitions[propertyId].propertyValueFunction(propertyId));
        }
        return undefined;
    };
    /**
    ...
    PageContextDataSource.prototype.getAnnotatedPropertyValue = function (propertyId) {
        if (this._propertyDefinitions[propertyId]) {
            ...
            return sp_lodash_subset_1.cloneDeep(this._propertyDefinitions[propertyId].annotatedPropertyValueFunction(propertyId));
        }
        else {
    ...
    PageContextDataSource.prototype.allowedEventsAsync = function () {
        ...
        return Promise.resolve(sp_lodash_subset_1.cloneDeep(retVal));
    };
    /**
...
exports.default = PageContextDataSource;
